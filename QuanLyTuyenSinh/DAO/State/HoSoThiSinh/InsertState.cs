...
{
    class InsertState : IState<ValueHoSoThiSinh>
    {
        public bool doCRUDAction(ValueHoSoThiSinh obj)
        {
            int insert = QuanLyTuyenSinhContext.Instance.ExecuteNonQuery("INSERTHoSoThiSinh @sbd , @hodem , @ten , @ngaysinh , @gioitinh , @tenhuyen , @tentinh , @doituong , @dantoc , @toan , @ly , @hoa , @sinh , @van , @su , @dia , @anhvan ", 
